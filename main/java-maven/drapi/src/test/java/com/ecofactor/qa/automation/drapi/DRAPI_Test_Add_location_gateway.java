...
public class DRAPI_Test_Add_location_gateway extends AbstractTest {
    ...
    public void drEventForComcast_add_loc_for_canceled_event(final String drUrl,
    ...
    @Test(groups = { Groups.SANITY1 }, dataProvider = "createDRLocationComCAST", dataProviderClass = DRAPIDataProvider.class, priority = 2)
    public void drEventForComcast_add_same_location_twice(final String drUrl,
            final String programID, final String eventID, final String targetType,
            final String targetALLJson) {
    ...
    @Test(groups = { Groups.SANITY1 }, dataProvider = "createDRLocationComCAST", dataProviderClass = DRAPIDataProvider.class, priority = 2)
    public void drEventForComcast_add_nve_loc(final String drUrl, final String programID,
            final String eventID, final String targetType, final String targetALLJson) {
        ...
        final HttpResponse response1 = HTTPSClient.putResponse(
                apiconfig.get(DRApiConfig.BASE_URL)
                        + apiconfig.get(DRApiConfig.URL_ADD_LOCATION)
                                ...
                                .replaceFirst("<event_id>", eventName),
                apiconfig
                        .get(DRApiConfig.ADD_LOCATION_MULTI)
                        .replaceFirst("<addlocation_id1>",
                                apiconfig.get(DRApiConfig.LOCATION_ID_ADD_NVE))
