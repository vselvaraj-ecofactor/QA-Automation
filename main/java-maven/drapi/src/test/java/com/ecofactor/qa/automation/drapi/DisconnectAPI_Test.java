...
public class DisconnectAPI_Test extends AbstractTest {
    ...
    public void test_get_disconnected_gateway_list_NVE(final String disconnectUrl,
    ...
    public void test_get_disconnected_gateway_list_CMCSA(final String disconnectUrl,
            final String programID) {
    ...
    public void test_get_disconnected_gateway_list_ECO(final String disconnectUrl,
            final String programID) {
    ...
    public void test_get_disconnected_gateway_list_Default(final String disconnectUrl,
            final String programID) {
    ...
    public void test_get_disconnected_gateway_Empty_Program(final String disconnectUrl,
            final String programID) {
    ...
    public void test_get_disconnected_gateway_Junk_Program(final String disconnectUrl,
            final String programID) {
        ...
        final HttpResponse response = HTTPSClient.getResponse(url,
                HTTPSClient.getPKCSKeyHttpClient("nopartnercode.p12", "ecofactor"));
        Assert.assertTrue(response.getStatusLine().getStatusCode() == 500, "Error status: "
                + response.getStatusLine());
        final String result = HTTPSClient.getResultString(response.getEntity());
        setLogString("response :'" + result + "'", true);
