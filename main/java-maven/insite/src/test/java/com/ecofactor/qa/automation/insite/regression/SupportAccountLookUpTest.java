 ...
 * Some of the features such as search by email Id, search by phone No, verifying the userDetail
 * etc.
 * </p>
 * *
 * @author Aximsoft
...
public class SupportAccountLookUpTest {
    ...
    /** The logger. */
    private static Logger logger = LoggerFactory.getLogger(SupportAccountLookUpTest.class);
    ...
    /**
     * <b>Test Case to search the particular email record by entering the email value, and verify
     * the search result is displayed.</b>
     * <ol>
    ...
    public void testSearchRecordsByEmailId(final String userName, final String password,
    ...
    /**
     * <b>Test Case to search the particular PhoneNo. record by entering the PhoneNo value, and
     * verify the search result is displayed.</b>
     * <ol>
    ...
    public void testSearchRecordsByPhoneNo(final String userName, final String password,
    ...
    /**
     * <b>Test case to check the Thermostat connectivity in the Installed hardware menu</b>.
     * @param userName the user name
     * @param password the password
     * @param emailId the email id
     */
    ...
    public void testThermostatConnectivityForInstalledHardware(final String userName,
     ...
     * @param userName the user name
     * @param password the password
     * @param searchEmailId the search email id
     */
    ...
    public void verifyAccountAndLocationInfo(final String userName, final String password,
    ...
    public void supportTabForNVEsuer(final String userName, final String password) {
    ...
    public void comcastEmailAndNameEmptyVerification(final String userName, final String password) {
    ...
    public void comcastIdVerification(final String userName, final String password) {
    ...
    public void comcastAccountAndLocationInfo(final String userName, final String password) {
    ...
    public void comcastEnergyEfficiencyCheck(final String userName, final String password) {
    ...
    public void comcastProxyLoginAndResetPwd(final String userName, final String password) {
    ...
    public void comcastExportOfflineThermostats(final String userName, final String password) {
    ...
    public void inValidElectrictyRate(final String userName, final String password,
     ...
     * @param password the password
     * @param searchEmailId the search email id
     * @param invalidPhoneNumber the invalid phone number
     */
    ...
    public void moreThan10DigitPhoneNumber(final String userName, final String password,
            final String searchEmailId, final String invalidPhoneNumber) {
        ...
        Assert.assertTrue(errorMessage.equalsIgnoreCase("Invalid phone number"),
    ...
    /*
     * @Test(dataProvider = "verifyEmailID", dataProviderClass = InsiteSupportDataProvider.class,
     * retryAnalyzer = RerunFailTestAnalyzer.class, groups = { "negative" }) public void
     * testInvalidEmailID(String userName, String password, String searchEmailId, String msg) {
     * supportLookUp.searchByEmail(searchEmailId); supportLookUp.clickSpecifiedEmail(searchEmailId);
     * supportLookUp.clickEmailIdEdit(); supportLookUp.enterEmailId("no @,.com");
     * Assert.assertTrue(supportLookUp.getErrorMessage().equalsIgnoreCase(msg));
     * supportLookUp.clickPopUpCancel(); }
     */
     ...
     * InsiteSupportDataProvider.class, retryAnalyzer = RerunFailTestAnalyzer.class, groups = {
     * "negative" }) public void testPastInstallationDate(String userName, String password, String
     * address, String date, String msg) { supportLookUp.clickScheduling();
     * supportLookUp.searchByAddress(address); supportLookUp.clickFirstAddress(address);
     ...
     * @param searchEmailId the search email id
     */
    @Test(dataProvider = "searchNonExsistingEmail", dataProviderClass = InsiteSupportDataProvider.class, retryAnalyzer = RerunFailTestAnalyzer.class, groups = { "negative" }, priority = 26)
    public void testNonExsistingEmail(final String userName, final String password,
            final String searchEmailId) {
     ...
     * @param userName the user name
     * @param password the password
     * @param searchPhoneNo the search phone no
     */
    @Test(dataProvider = "searchNonExsistingPhoneNo", dataProviderClass = InsiteSupportDataProvider.class, retryAnalyzer = RerunFailTestAnalyzer.class, groups = { "negative" }, priority = 27)
    public void testNonExsistingPhoneNumber(final String userName, final String password,
     ...
     */
    @Test(dataProvider = "searchNonExsistingId", dataProviderClass = InsiteSupportDataProvider.class, retryAnalyzer = RerunFailTestAnalyzer.class, groups = { "negative" }, priority = 28)
    public void testNonExsistingId(final String userName, final String password,
     ...
     * @param userName the user name
     * @param password the password
     * @param searchStreetAddress the search street address
     */
    @Test(dataProvider = "searchNonExsistingStreet", dataProviderClass = InsiteSupportDataProvider.class, retryAnalyzer = RerunFailTestAnalyzer.class, groups = { "negative" }, priority = 29)
    public void testNonExsistingStreetAddr(final String userName, final String password,
    ...
    public void searchByValidEmail(final String userName, final String password,
    ...
    public void searchByValidPhoneNumber(final String userName, final String password,
            final String searchPhoneNo) {
    ...
    public void searchByValidStreetAddress(final String userName, final String password,
            final String searchStreetAddress) {
    ...
    public void searchByValidId(final String userName, final String password, final String searchId) {
    ...
    public void searchByPartialEmail(final String userName, final String password,
            final String email, final String searchEmail) {
    ...
    public void searchByPartialPhoneNumber(final String userName, final String password,
            final String phoneNo, final String searchPhoneNo) {
    ...
    public void searchByPartialStreetAddress(final String userName, final String password,
            final String streetAddress, final String searchStreetAddress) {
    ...
    /**
     * <ol>
     * <li>Login via Admin and reset the password for the specified user and check it in consumer
     * portal.</li>
     * </ol>
     * @param userName the user name
     * @param password the password
    ...
    public void testResetPasswordViaAdmin(final String userName, final String password,
            final String searchEmailId, final String searchUserName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String newAppUrl, final String newPassword) {
         ...
         * "proxy login for the user with new temporay password sent via eamil.", true);
         * insiteLogin.loadPage(); insiteLogin.login(userName, password);
         * supportLookUp.clickSupport(); supportLookUp.searchByEmail(searchEmailId);
         * supportLookUp.clickSearchedResultElement(searchEmailId); supportLookUp.clickProxyLogin();
         */
        smallWait();
        supportLookUp.doVerifyPswdResetByNewAppLogin(searchEmailId, temporaryPassword, newPassword,
                newAppUrl);
    }
