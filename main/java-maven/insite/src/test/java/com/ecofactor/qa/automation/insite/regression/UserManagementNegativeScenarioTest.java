...
public class UserManagementNegativeScenarioTest {
    ...
    public void testCreateNewUserInActive(final String userName, final String password,
        ...
        userManagement.logout();
        String temporaryPassword = gmail.getChangedPassword(emailUrl, emailUserName, emailPassword,
                subject, 0, 0);
    ...
    public void testCreateNewUserEmptyFirstName(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
        ...
        currentDate = new Date();
        dateTimeStamp = formatter.format(currentDate);
        userManagement.fillNewUserClickSave(firstName, lastName, emailAddress, accountUserName
                + dateTimeStamp, activeUser, partnerType, partner, streetAddress1, streetAddress2,
                city, state, zip, country, mobilePhoneNumber, homePhoneNumber, fax, availableRole);
        Assert.assertTrue(userManagement.getUserSaveError().contains("Firstname cannot be null"),
    ...
    public void testCreateNewUserEmptyLastName(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
        ...
        userManagement.fillNewUserClickSave(firstName, lastName, emailAddress, accountUserName
                + dateTimeStamp, activeUser, partnerType, partner, streetAddress1, streetAddress2,
                city, state, zip, country, mobilePhoneNumber, homePhoneNumber, fax, availableRole);
        Assert.assertTrue(userManagement.getUserSaveError().contains("Lastname cannot be null"),
                "Expected Text Not Found");
        userManagement.logout();
    ...
    public void testCreateNewUserEmptyEmail(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
        ...
        userManagement.fillNewUserClickSave(firstName, lastName, emailAddress, accountUserName
                + dateTimeStamp, activeUser, partnerType, partner, streetAddress1, streetAddress2,
                city, state, zip, country, mobilePhoneNumber, homePhoneNumber, fax, availableRole);
        Assert.assertTrue(userManagement.getUserSaveError().contains("Email cannot be null"),
                "Expected Text Not Found");
        userManagement.logout();
    ...
    public void testCreateNewUserEmptyUserName(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
        ...
        dateTimeStamp = formatter.format(currentDate);
        userManagement.fillNewUserClickSave(firstName, lastName, emailAddress, accountUserName,
                activeUser, partnerType, partner, streetAddress1, streetAddress2, city, state, zip,
                country, mobilePhoneNumber, homePhoneNumber, fax, availableRole);
        Assert.assertTrue(userManagement.getUserSaveError().contains("User save failed"),
                "Expected Text Not Found");
        userManagement.logout();
    ...
    public void testCreateNewUserEmptyPartner(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserEmptyRole(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserStateNumber(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserCountryNumber(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserZipChar(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewMobileNumberChar(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserPhoneNumberChar(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void testCreateNewUserFaxNumberChar(final String userName, final String password,
            final String firstName, final String lastName, final String emailUrl,
            final String emailUserName, final String emailPassword, final String subject,
            final String emailAddress, final String accountUserName, final String activeUser,
            final String partnerType, final String partner,
    ...
    public void adminInvalidEmailAddress(String userName, String password, String emailAddress,
            String invalidEmail, String msg) {

        userManagement.searchByEmail(emailAddress);
        userManagement.clickEditIcon();
        userManagement.editEmailAddress(invalidEmail);
        userManagement.clickSave();
        Assert.assertTrue(userManagement.getErrorMessage().equalsIgnoreCase(msg));
    }
    ...
    public void testNonExsistingName(final String userName, final String password,
