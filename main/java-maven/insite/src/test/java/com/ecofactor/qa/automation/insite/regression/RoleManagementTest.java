...
public class RoleManagementTest {
	...
	private static Logger logger = LoggerFactory
			.getLogger(RoleManagementTest.class);
	 ...
	 *            the available pages
	 * @param unAssignedPermission
	 *            the un assigned permission
	 */
	...
	public void testCreateNewRole(final String userName, final String password,
			final String roleName, final String roleDescription,
			final String partnerType, final String unAssignedPermission) {

		roleManagement.loadPage(userName, password);
		final int partnerValidType = Integer.parseInt(partnerType);
		roleManagement.createNewRole(roleName, roleDescription,
				unAssignedPermission, partnerValidType);
	}
	...
	public void createRoleForSystemAdmin(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
	...
	public void createRoleForInstallationPartner(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForServiceProvider(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForUtilityPartner(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForCustomerCareAccount(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForCustomerCareOnBoarding(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForCCAccountOnBoarding(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForInstaller(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForInstallerScheduling(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForInstallerOnsite(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForInstallerPreconfig(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForIns_Pre_Scheduling(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForIns_Scheduling_Onsite(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForIns_Preconfig_Install(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForEcofactorContractor(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForUtilityDR(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForUtilityDRLookUp(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
	...
	public void createRoleForConservationPartner(final String userId,
			final String password, final String roleName,
			final String roleDescription, final String partnerType,
			final String unAssignedPermission) {
