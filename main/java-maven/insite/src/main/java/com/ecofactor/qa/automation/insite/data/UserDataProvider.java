...
public class UserDataProvider {
	...
	public static Object[][] validLogin(Method m) {
		...
		Object[][] data = { {
				userTestConfig.get(UserTestConfig.VALID_LOGIN_USER),
	...
	public static Object[][] UserTestConfig(Method m) {
		...
		Object[][] data = { {
				...
				userTestConfig.get(UserTestConfig.CITY),
				userTestConfig.get(UserTestConfig.STATE),
				userTestConfig.get(UserTestConfig.ZIP),
				userTestConfig.get(UserTestConfig.COUNTRY),
	...
	public static Object[][] createUserNeagtive(Method m) {
		...
		Object[][] data = { {
				userNegativeTestConfig.get(UserTestConfig.VALID_LOGIN_USER),
				userNegativeTestConfig
						.get(UserNegativeTestConfig.VALID_LOGIN_PASSWORD),
				...
				userNegativeTestConfig
						.get(UserNegativeTestConfig.ACCOUNT_USER_NAME),
				userNegativeTestConfig
						.get(UserNegativeTestConfig.INACTIVE_USER),
				...
				userNegativeTestConfig
						.get(UserNegativeTestConfig.AVAILABLE_ROLE),
	...
	public static Object[][] searchNonExsistingEmail(Method m) {
		...
		Object[][] data = { {
				...
				userTestConfig.get(UserTestConfig.VALID_LOGIN_PASSWORD),
				userNegativeTestConfig
						.get(UserNegativeTestConfig.NON_EXSISTING_EMAIL) } };
		return data;
	}
	...
	public static Object[][] searchNonExsistingName(Method m) {
		...
		Object[][] data = { {
				...
				userTestConfig.get(UserTestConfig.VALID_LOGIN_PASSWORD),
				userNegativeTestConfig
						.get(UserNegativeTestConfig.NON_EXSISTING_NAME) } };
		return data;
	}
	...
	public static Object[][] loginToEmils(Method m) {
		...
		Object[][] data = { {
				userTestConfig.get(UserTestConfig.SCHEDULELINK_USERNAME),
	...
	public static Object[][] loginToEmilAdmin(Method m) {
		...
		Object[][] data = { {
				userTestConfig.get(UserTestConfig.EMILADMIN_USERNAME),
	...
	public static Object[][] loginToNVEUsers(Method m) {
		...
		Object[][] data = { {
				userTestConfig.get(UserTestConfig.NVE_USERNAME_1),
