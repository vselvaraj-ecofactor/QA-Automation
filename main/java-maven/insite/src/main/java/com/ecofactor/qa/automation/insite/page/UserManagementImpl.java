...
public class UserManagementImpl extends InsiteAuthenticatedPageImpl implements UserManagement {
    ...
    public void changeAccountDetails(final String firstName, final String lastName,
        ...
        if (lastName != null && !lastName.isEmpty()) {
            ...
            lastNameElemt.sendKeys(lastName);
        }
        ...
        if (emailAddress != null && !emailAddress.isEmpty()) {
            ...
            emailElemt.sendKeys(emailAddress);
        }
    ...
    public void verifyRoleDetails() {
        ...
        final WebElement roleTab = DriverConfig.getDriver().findElement(By.id("roles"));
        roleTab.click();
        tinyWait();
    ...
    public void verifyUserAndClickEditButton(final String accountUserName) {
        ...
        for (final WebElement webElement : searchResultList) {
            if (webElement.getText() != null && webElement.getText().contains(accountUserName)) {
                final WebElement anchorElemt = webElement.findElement(By.tagName("a"));
                anchorElemt.click();
    ...
    private void clickRole() {
        ...
        isDisplayedById(DriverConfig.getDriver(), "roles", SHORT_TIMEOUT);
    ...
    public void clickEditIcon() {
        ...
        final List<WebElement> editList = retrieveElementsByAttributeValueList(
                DriverConfig.getDriver(), "img", "alt", "Edit");
     ...
     */
    public void editEmailAddress(final String email) {

        final WebElement mailElement = DriverConfig.getDriver().findElement(By.id("email"));
        mailElement.clear();
    ...
    public int getCurrentPageNo() {
        ...
        WebElement element = DriverConfig.getDriver().findElement(By.cssSelector("input.pagedisplay.ef_smallLabel.ieFix"));
