 ...
 * @version $Rev:$ $Date:$
 */
public class ThermostatAlgoControlDaoImpl extends BaseDaoImpl<ThermostatAlgorithmController> implements ThermostatAlgoControlDao {
     ...
     */
    public ThermostatAlgorithmController findZeroPhaseActiveEvent(Integer thermostatId, Integer algoId, Double baseTemp) {
     ...
     *      java.lang.Integer, java.lang.Double)
     */
    public ThermostatAlgorithmController findFirstPhaseActiveEvent(Integer thermostatId, Integer algoId, Double baseTemp) {
     ...
     */
    @Override
    public Boolean saveThermostatAlgorithmController(List<ThermostatAlgorithmController> thermostatAlgorithmController) {
     ...
     */
    @Override
    public Boolean updateThermostatAlgorithmControllerList(List<ThermostatAlgorithmController> thermostatAlgorithmController) {
     ...
     */
    @Override
    public Boolean updateThermostatAlgorithmController(ThermostatAlgorithmController thermostatAlgorithmController) {
    ...
    public ThermostatAlgorithmController findSPOStart(Integer thermostatId, Integer algoId) {
        ...
        paramVals.put("thermostatId", thermostatId);
        paramVals.put("algoId", algoId);
        List<ThermostatAlgorithmController> thermostatAlgoCtrl = listQueryByLimit(query, paramVals, 1);
        return thermostatAlgoCtrl.get(0);
    }

    @Override
    public List<ThermostatAlgorithmController> listAlgoControlForAlgorithm(Integer thermostatId, Integer algoId) {
