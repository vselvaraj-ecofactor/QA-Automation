...
/**
 * ReportsAPIConfig configures the Reports API.
 * @author $Author:$
 * @version $Rev:$ $Date:$
 */
public class ReportsAPIConfig extends BaseConfig {
     ...
     */
    @Inject
    public ReportsAPIConfig(DriverConfig driverConfig) {
